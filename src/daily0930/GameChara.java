...
public abstract class GameChara {
	...
	public static final int AREA_X2 = UtyuuShoot.GAMEN_W + 48;
	public static final int AREA_Y2 = UtyuuShoot.GAMEN_H + 48;
	...
	public boolean isSotoNiDeta(){
		...
		if (chara_x < AREA_X1 || chara_y < AREA_Y1 ||
				chara_x + image_w > AREA_X2 || chara_y + image_h > AREA_Y2 ){
			return true;
	} else {
		return false;
		}
